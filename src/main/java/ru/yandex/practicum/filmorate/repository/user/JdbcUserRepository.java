...
public class JdbcUserRepository implements UserRepository {
    ...
    public void addFriend(long userId, long friendId) {
       /* String sqlStatuses = "SELECT STATUS FROM USER_FRIENDS WHERE USER_ID = :friendId AND FRIEND_ID = :userId";
        ...
        if (statuses.isEmpty()) {
            ...
            String sqlUpdate = "UPDATE USER_FRIENDS SET STATUS = 'confirmed' WHERE (USER_ID = :userId AND FRIEND_ID = :friendId) OR (USER_ID = :friendId AND FRIEND_ID = :userId)";
        ...
        jdbc.update("INSERT INTO USER_FRIENDS (USER_ID,FRIEND_ID) " +
    ...
    public List<User> getCommonFriends(long userId, long otherUserId) {
        ...
        String sql = "SELECT u.* from USERS u WHERE u.id IN (SELECT FRIEND_ID FROM USER_FRIENDS WHERE USER_ID = :userId)" +
                " AND u.id IN (SELECT FRIEND_ID FROM USER_FRIENDS WHERE USER_ID = :otherUserId)";
        return jdbc.query(sql, Map.of("userId", userId, "otherUserId", otherUserId), mapper);
    }
